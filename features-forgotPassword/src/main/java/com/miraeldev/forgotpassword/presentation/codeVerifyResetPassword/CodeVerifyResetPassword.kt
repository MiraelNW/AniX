...
fun CodeVerifyResetPassword(
    ...
    viewModel: CodeVerifyResetPasswordViewModel = hiltViewModel()
) {
    val scrollState = rememberScrollState()

    var enabled by rememberSaveable { mutableStateOf(true) }

    val isOtpCorrect by viewModel.isOtpCorrect.collectAsStateWithLifecycle()
    ...
    Column(
        ...
        com.miraeldev.presentation.Toolbar(
