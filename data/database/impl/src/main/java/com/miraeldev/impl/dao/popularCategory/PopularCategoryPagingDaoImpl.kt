...
import com.miraeldev.impl.mapper.mapToInitialSearchDbModel
...
@Inject
class PopularCategoryPagingDaoImpl(private val database: Database) : PopularCategoryPagingDao {
    private val query = database.popular_category_paging_tableQueries
