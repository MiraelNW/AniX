package com.miraeldev.videoscreen.presentation.playerControls
...
import com.miraeldev.videoscreen.presentation.DropItem
import com.miraeldev.videoscreen.presentation.QualityItems
import com.miraeldev.videoscreen.presentation.utilis.formatMinSec

private const val PORTRAIT = 0
private const val LANDSCAPE = 1

@Composable
internal fun PortraitBottomControls(
    modifier: Modifier,
    quality: String,
    totalDuration: () -> Long,
    currentTime: Long,
